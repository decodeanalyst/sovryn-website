            ...
            <div className="container-fluid" id="div-desktop">
                ...
                <div className="row py-5">
                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="p-2"></div>
                        <StyledButton text="go to margin trade" pageName="margin-trade" />
                    </div>
                    <div className="col-lg-4">
                        ...
                        <div className="p-2"></div>
                        <StyledButton text="go to stake" pageName="stake" />
                    </div>
                </div>
                ...
                <div className="row">
                    <div className="col-lg-4">
                        ...
                        <div className="p-2"></div>
                        <StyledButton text="go to borrow" pageName="borrow" />
                    </div>
                    <div className="col-lg-4">
                        ...
                        <div className="p-2"></div>
                        <StyledButton text="go to lend" pageName="lending" />
                    </div>
                    <div className="col-lg-4">
