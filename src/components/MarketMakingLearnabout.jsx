...
export default function MarketMakingLearnabout() {
    return (
        <>
            <div className="pb-60">
                <div className="margin-trade-learning">
                    <div className="row">
                                ...
                                return (
                                    <div className="h-auto  pr-4  rectangle w-100 mb-3">
                                        <div className="align-items-center d-flex">
                                            <div className="learning-icon bg-yellow">
                                                <FontAwesomeIcon icon={['fab', [`${e.icons}`]]} size="2x" transform="shrink-5" />
                                            </div>
