...
import "../styles/StakeExchnagessection.scss";
import StyledButton from "../components/StyledButton";

export default function StakeExchnagessection() {
    return (
        <>
       <div className="container-fluid" id="div-desktop">
        ...
        <div className="row  mt-7">
            <div className="col-md-12 col-sm-12">
                <div className="stake-exchange-hero-label">
            ...
            <div className="col-md-12 col-sm-12 mt-5">
                <div className="row">
                    <div className="col-md-3 col-sm-3">
                        <div className="stake-rectangle-info">
                        </div>
                    </div>
                    <div className="col-md-3 col-sm-3">
                   <div className="stake-rectangle-info">
       ...
       {/* <div className="row mt-5">
                               ...
                               <div className="row">
                                   ...
                                   <div className="col-md-6 col-sm-6">
                                        <h4 className="lend-box-headding">4. Buy SOV on Exchanges</h4>
                                            <div class="stake-exchange-text stake-exchange-top-30">
                                            <div class="p-1 lend-format">
                                                <div className="lend-format p-2"><p>
        ...
        <div className="row  mt-7">
            <div className="col-md-12 col-sm-12">
                <div className="stake-exchange-hero-label-mob">
                    <h3>Where and how can I get SOV?</h3>
                </div>
            </div>
        </div>
