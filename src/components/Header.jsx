          ...
          <ul className="navbar-nav mr-auto">
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu" aria-labelledby="dropdown05">
                ...
                <a className="dropdown-item" href="/margin-trade">
                  MARGIN
                </a>
                <a className="dropdown-item" href="/stake">
                  STAKE
                </a>
                <a className="dropdown-item" href="/borrow">
                  BORROW
                </a>
            ...
            <li className="titles nav-item">
              <a className="nav-link btn btn-white" href="/aboutus">
                About
              </a>
            </li>
            <li className="titles nav-item">
              <a className="nav-link btn btn-white" href="/faq">
                FAQ
              </a>
            </li>
          </ul>
