        ...
        <div className="container-fluid" id="div-desktop">
                ...
                <div className="col-md-6 float-left">
                        ...
                        <div className="col-md-6 float-left mtp-200">
                            ...
                            <div className="about-us-hero-section-headding align-items-start"><p>Bitcoin, despite of having the biggest liquidity pool, and being the reserve currency of the crypto world has been cut out of DEFI. </p></div>
